...
# Enable i386 architecture for multiarch support
$SUDO dpkg --add-architecture i386

# Update and install jq first (needed for properties.sh)
...
# Fix ownership of TERMUX__PREFIX and TERMUX_APP__DATA_DIR
